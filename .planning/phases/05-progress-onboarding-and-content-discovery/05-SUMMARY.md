...
## Plan Inventory
- [ ] 05-01-PLAN.md (Wave 1) - Anonymous/account lesson completion persistence (LEARN-08)
- [ ] 05-02-PLAN.md (Wave 2) - Onboarding capture, recommendations, and skip suppression behavior (ONBD-01 to ONBD-03)
- [ ] 05-03-PLAN.md (Wave 3) - Content library filters/search, recap integration, and text-only discussion with SEO-Max gate (DISC-01 to DISC-03)
...
## Verification Gate
- [ ] Lesson completion persists across restart for both anonymous and account users.
- [ ] Onboarding output is exactly three starter lessons plus one benchmark challenge.
- [ ] Skip path suppresses repeat prompt and routes to homepage.
- [ ] Library supports combined filters and search narrowing behavior.
- [ ] Discussion board remains text-only (no upvote/ranking/feed behavior).
