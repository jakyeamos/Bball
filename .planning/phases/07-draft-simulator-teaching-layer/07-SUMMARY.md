...
- Execution order: 07-01 -> 07-02.
- 07-02 includes final human verification before broad rollout.

## Key Risks
- Legacy visual tokens may leak into draft surfaces if token migration is partial.
- Contextual overlays can become noisy if trigger logic is not calibrated.
...
- Phase 8 and later phases can treat simulator as educational capstone surface.
