...
## Plan Inventory
- [x] 03-01-PLAN.md (Wave 1) - Build-time BallDontLie seed generation and artifact reproducibility (DATA-01)
- [x] 03-02-PLAN.md (Wave 2) - Disk cache warm-up/refresh flows and coach tendency seed completeness (DATA-02, DATA-03)
- [x] 03-03-PLAN.md (Wave 3) - nba_api extension and explicit 30-field PlayerFeatures mapping with tests/docs (DATA-04, DATA-05)
...
## Verification Gate
- [x] Seed script produces deterministic nba-seed artifacts with metadata.
- [x] Server startup performs cache warm-up and request path avoids direct BallDontLie calls.
