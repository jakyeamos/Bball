...
**Server boots a disk-only NBA identity cache and a full coach tendency table without live BallDontLie calls.**
...
- `server/services/dataCache.ts`, `server/scripts/refreshBallDontLieCache.ts`, `server/data/coaches-seed.json`, `docs/data/cache-operations.md`, `server/index.ts`, `server/package.json`.
